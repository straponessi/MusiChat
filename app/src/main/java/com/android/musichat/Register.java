...
public class Register extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://musichat-ed84b-default-rtdb.firebaseio.com/");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AppCompatButton registerBrn = findViewById(R.id.r_registerBtn);
        ...
        registerBrn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(nameTxt.isEmpty() || mobileTxt.isEmpty() || emailTxt.isEmpty()){
                    Toast.makeText(Register.this, "Иди-ка нахуй другалек", Toast.LENGTH_SHORT).show();
